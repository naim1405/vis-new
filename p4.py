...
class STGCNInference:
    def __init__(self, model_path="stg_nf_latest.pth", device=None):
        """
    ...
    def load_model(self):
        ...
        try:
            ...
            if isinstance(checkpoint, dict) and 'model_state_dict' in checkpoint:
                ...
                raise NotImplementedError("Model class definition needed. Please provide STGCN architecture.")
            else:
...
def get_model_instance(model_path="stg_nf_latest.pth", device=None):
    """
...
def predict_normality(input_data, model_path="stg_nf_latest.pth"):
    """
...
if __name__ == "__main__":
    ...
    model_handler = STGCNInference("stg_nf_latest.pth")
