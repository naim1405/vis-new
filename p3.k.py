...
model = YOLO("yolov8n-pose.pt")  # should download or load without error
...
class FrameBufferManager:
    ...
    def __init__(
        self,
        pose_model_path: str = "E:\\He_is_enough03 X UniqoXTech X Dreams\\Click_here\\Artificial Intelligence\\VisionGaurd.ai\\VisionGuard\\pipeline\\yolov8n-pose.pt",
...
if __name__ == "__main__":
    ...
    manager = FrameBufferManager(
        pose_model_path="E:\\He_is_enough03 X UniqoXTech X Dreams\\Click_here\\Artificial Intelligence\\VisionGaurd.ai\\VisionGuard\\pipeline\\yolov8n-pose.pt",
        sequence_length=1,
        frame_digits=4,
        device="cpu",
    )
